...
func TestCopyFile(t *testing.T) {
	...
	if err := osutil.CopyFile(tmpfile.Name(), copyfile); err != nil {
		t.Fatal(err)
	}
...
func TestEnsureDir(t *testing.T) {
	...
	err := osutil.EnsureDir(filepath.Join(tmp, "dir"), 0755)
...
func TestTrickedTruncation(t *testing.T) {
	...
	if err := osutil.CopyFile(tmpDir, originalWALPath); err == nil {
